...
--inputs--
FCTL_INPUT_X =   globalProperty("sim/joystick/yoke_roll_ratio")
FCTL_INPUT_Y =   globalProperty("sim/joystick/yoke_pitch_ratio")
...
Flightmodel_PLG_L  = globalProperty("sim/flightmodel/forces/L_plug_acf")
Flightmodel_PLG_M  = globalProperty("sim/flightmodel/forces/M_plug_acf")
Flightmodel_PLG_N  = globalProperty("sim/flightmodel/forces/N_plug_acf")
