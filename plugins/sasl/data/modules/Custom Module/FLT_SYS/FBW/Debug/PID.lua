...
function update()
    ...
    Grapher_update(test_tbl, {
        ["q PID output"] = {graph = true, number = true, color = ECAM_WHITE, value = FBW.PIDs.phidot.output},
        ["q PID error"] = {graph = true, number = true, color = ECAM_RED, value = FBW.PIDs.phidot.error},
